...
func TestCalculateArea(t *testing.T) {
	tests := []struct {
		...
		{"Прямоугольник_НевернаяШирина", rectangle{width: -4, height: 5}, 0, "ширина и высота не могут быть отрицательными"},
		{"Треугольник", triangle{base: 4, height: 3}, 6, ""},
		{"Треугольник_НеверноеОснование", triangle{base: -4, height: 3}, 0, "основание и высота не могут быть отрицательными"},
		{"НеверныйТип", "неверный", 0, "объект не является фигурой"},
	}
